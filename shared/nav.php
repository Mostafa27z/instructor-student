  ...
  <div class="container-fluid text-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link text-light" href="add.php">| Add Instructor</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-light" href="tasks.php">| Instructors </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-light" href="addstd.php">| Add student</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-light" href="student.php">| Students</a>
        </li>
        <li class="nav-item">
